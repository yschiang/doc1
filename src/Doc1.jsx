...
const ThreeLayerDiagram = () => (
  <div style={{ margin: "32px 0", display: "flex", justifyContent: "center" }}>
    <svg viewBox="0 0 700 520" style={{ width: "100%", maxWidth: 700 }} xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="180" y="72" fontSize="14" fontWeight="700" textAnchor="middle" fill={T.text}>Track-in Check</text>
      <text x="180" y="90" fontSize="12" textAnchor="middle" fill={T.textSec}>TCS 自動觸發 · per lot · 固定流程</text>
      ...
      {/* Bulkhead: Track-in (Layer 2 + Layer 1) */}
      <rect x="20" y="165" width="320" height="310" rx="12" fill="#FFF" stroke="#93C5FD" strokeWidth="2" />
      <text x="40" y="190" fontSize="13" fontWeight="700" fill="#2563EB">Track-in 隔離艙</text>
...
const TechBoundaryDiagram = () => (
  <div style={{ margin: "32px 0", display: "flex", justifyContent: "center" }}>
    <svg viewBox="0 0 700 440" style={{ width: "100%", maxWidth: 700 }} xmlns="http://www.w3.org/2000/svg">
      {/* Track-in trigger */}
      <text x="155" y="20" fontSize="13" fontWeight="600" fill="#7C3AED" textAnchor="middle">Track-in（自動）</text>
      <text x="155" y="36" fontSize="11" fill={T.textSec} textAnchor="middle">TCS per lot · system auth</text>
      ...
      <text x="40" y="105" fontSize="12" fontWeight="700" fill="#2563EB">Track-in 隔離艙</text>

      {/* Spring Boot inside track-in */}
      ...
      <text x="170" y="355" fontSize="11" fill={T.textSec} textAnchor="middle">→ TCS · EDI · DB · NAS · 機台</text>
      ...
      <text x="520" y="383" fontSize="11" fill={T.textSec} textAnchor="middle">→ TCS · EDI · DB · NAS · 機台</text>
...
const TwoWorldDiagram = () => (
  <div style={{ margin: "32px 0", display: "flex", justifyContent: "center" }}>
    <svg viewBox="0 0 680 520" style={{ width: "100%", maxWidth: 680 }} xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="320" y="108" fontSize="13" fontFamily="monospace" fill="#666">compareMode（V2 支持多種）</text>
      ...
      <text x="180" y="435" fontSize="14" fontWeight="600" textAnchor="middle" fill="#1a1a1a">Recipe fetcher</text>
      <text x="180" y="458" fontSize="12" textAnchor="middle" fontFamily="monospace" fill="#666">VIA_TCS → TCS</text>
      <text x="180" y="476" fontSize="12" textAnchor="middle" fontFamily="monospace" fill="#666">VIA_EDI → EDI</text>

      <rect x="310" y="410" width="220" height="80" rx="8" fill="#E0F2FE" stroke="#7DD3FC" strokeWidth="1.5" />
      <text x="420" y="435" fontSize="14" fontWeight="600" textAnchor="middle" fill="#1a1a1a">Recipe comparator</text>
...
const ResolverDiagram = () => (
  <div style={{ margin: "32px 0", display: "flex", justifyContent: "center" }}>
    <svg viewBox="0 0 560 320" style={{ width: "100%", maxWidth: 560 }} xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="80" y="298" fontSize="13" fontWeight="600" textAnchor="middle">Process V2</text>
      <rect x="155" y="275" width="110" height="36" rx="8" fill="#DCFCE7" stroke="#86EFAC" strokeWidth="1.5" />
      <text x="210" y="298" fontSize="13" fontWeight="600" textAnchor="middle">Process V1</text>
      <rect x="285" y="275" width="110" height="36" rx="8" fill="#DCFCE7" stroke="#86EFAC" strokeWidth="1.5" />
      <text x="340" y="298" fontSize="13" fontWeight="600" textAnchor="middle">Scanner</text>
      <rect x="410" y="275" width="120" height="36" rx="8" fill="#DCFCE7" stroke="#86EFAC" strokeWidth="1.5" />
      <text x="470" y="298" fontSize="13" fontWeight="600" textAnchor="middle">Metrology</text>
    </svg>
  </div>
);
...
const AdapterDiagram = () => (
  <div style={{ margin: "32px 0", display: "flex", justifyContent: "center" }}>
    <svg viewBox="0 0 500 260" style={{ width: "100%", maxWidth: 500 }} xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="250" y="125" fontSize="14" fontWeight="600" textAnchor="middle" fill="#1a1a1a">RecipeFetcher（介面）</text>

      <line x1="165" y1="140" x2="130" y2="170" stroke="#999" strokeWidth="1.5" />
      <text x="80" y="166" fontSize="12" fill="#666">VIA_TCS</text>
      <line x1="335" y1="140" x2="370" y2="170" stroke="#999" strokeWidth="1.5" />
      <text x="383" y="166" fontSize="12" fill="#666">VIA_EDI</text>

      <rect x="40" y="180" width="190" height="55" rx="8" fill="#E0F2FE" stroke="#7DD3FC" strokeWidth="1.5" />
      <text x="135" y="205" fontSize="14" fontWeight="600" textAnchor="middle" fill="#1a1a1a">TCS adapter</text>
      <text x="135" y="225" fontSize="12" textAnchor="middle" fill="#666">V1, V2, Metrology</text>

      <rect x="270" y="180" width="190" height="55" rx="8" fill="#E0F2FE" stroke="#7DD3FC" strokeWidth="1.5" />
      <text x="365" y="205" fontSize="14" fontWeight="600" textAnchor="middle" fill="#1a1a1a">EDI adapter</text>
      <text x="365" y="225" fontSize="12" textAnchor="middle" fill="#666">Scanner</text>
    </svg>
  </div>
);
          ...
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, margin: "20px 0" }}>
              <div style={{ background: T.cardBg, border: `1px solid ${T.border}`, borderRadius: 10, padding: 20 }}>
                <div style={{ fontWeight: 700, marginBottom: 6 }}>Track-in Check</div>
                <div style={{ fontSize: 14, color: T.textSec, lineHeight: 1.7 }}>
                  TCS 自動觸發，per lot/run<br />
                  機台 track-in 時做比對、必要時調機<br />
              ...
              <div style={{ background: T.cardBg, border: `1px solid ${T.border}`, borderRadius: 10, padding: 20 }}>
                ...
                <div style={{ fontSize: 14, color: T.textSec, lineHeight: 1.7 }}>
                  人開工單觸發，per tool<br />
                  預定義 template（全機比對、調機...）<br />
                  可容忍延遲，但不能影響 track-in
                </div>
              </div>
            </div>

            <P>兩個場景底下，每台機台都要支援同一組操作：compare、view、get、update。這組操作要能跑在 4 套不同的系統上（Process V2、V1、Scanner、Metrology），而且兩個場景不能互相影響。</P>
            ...
            <Table
              headers={["層級", "職責", "關鍵字"]}
              rows={[
                ["Layer 3 · Flow", "觸發、編排、auth", "track-in check / workflow template"],
                ["Layer 2 · Operation", "compare / view / get / update", "Spring Boot — 決策、編排"],
                ["Layer 1 · 差異隔離", "讓操作跑在不同系統上", "Planner → Plan → Executor → Adapter"],
              ]}
            />

            <P>Layer 2 + Layer 1 整組部署兩份（隔離艙）：track-in 和 workflow 各一組 instance，同一份 code、獨立 scaling、獨立 resource，避免 workflow 的 heavy 操作拖慢 track-in。</P>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 10, margin: "20px 0" }}>
              {[
                { title: "RMS Process V2", items: ["compare-svc", "recipe-svc", "tcs-gateway", "recipe-db"] },
                { title: "RMS Process V1", items: ["compare-svc", "recipe-svc", "tcs-client", "recipe-db"] },
                { title: "RMS Scanner", items: ["compare-svc", "recipe-svc", "edi-connector", "recipe-db"] },
                { title: "RMS Metrology", items: ["compare-svc", "recipe-svc", "tcs-client", "recipe-db"] },
              ].map((sys, i) => (
            ...
            <GoalBox
              ...
              subs={<>Client 不知道有 4 套系統 → 統一入口<br />4 套系統大同小異 → 共用骨架，差異用資料描述<br />逐漸往 V2 靠攏 → 改資料就好，不改程式碼</>}
            />
            ...
            <P>兩個設計決定。第一，API 的參數是 <Code>toolId</Code> 不是 <Code>rmsType</Code> — Client 不需要知道機台歸哪套系統管，路由是系統內部的事。第二，4 個 Strategy 都實作同一個介面 <Code>RecipeOperations</Code>，Resolver 拿到的東西可以直接呼叫。</P>

            <H3>RecipeOperations 介面</H3>
            <CodeBlock>{`interface RecipeOperations {
  compare(toolId, recipeName, options) → CompareResult
  view(toolId, recipeName) → Recipe
  get(toolId, recipeName) → Recipe
  update(toolId, recipeName, content) → MutationResult
}`}</CodeBlock>

            <P>每套系統有對應的實作（行為收斂的系統可以共用），內部都用 Pattern 2 的結構：</P>
            <CodeBlock>{`class ProcessV2Operations implements RecipeOperations {
  compare(toolId, recipeName, options) {
    plan = this.planner.plan(toolId, options)  // 算（Spring Boot）
    return this.executor.execute(plan)          // 做（C++）
  }
}`}</CodeBlock>

            <P>Pattern 1（RecipeOperations + Resolver）是外層結構 — 決定「誰來處理」。<br />
            ...
            <P>先講一個觀察。把 track-in check 裡的「比對」拆開來看，它其實在做這些事：</P>

            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, margin: "24px 0" }}>
              {[
                { title: "取 recipe", q: "怎麼取？走 TCS 還是 EDI？" },
                { title: "取 golden", q: "要不要取？TCS 端比就不用" },
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, margin: "20px 0" }}>
              <div style={{ background: T.cardBg, border: `1px solid ${T.border}`, borderRadius: 10, padding: 20 }}>
                <div style={{ fontWeight: 700, marginBottom: 6 }}>V1 / V2 — TCS 端比</div>
                <div style={{ fontSize: 14, color: T.textSec, lineHeight: 1.7 }}>
                  TCS track-in 時呼叫 RMS<br />
                  RMS 回傳 recipe 給 TCS<br />
                  <strong>TCS 自己比</strong>，RMS 不做比對<br />
                  RMS 的角色是「提供資料」
                </div>
              </div>
              <div style={{ background: T.cardBg, border: `1px solid ${T.border}`, borderRadius: 10, padding: 20 }}>
                <div style={{ fontWeight: 700, marginBottom: 6 }}>Scanner / Metrology — RMS 端比</div>
                <div style={{ fontSize: 14, color: T.textSec, lineHeight: 1.7 }}>
                  RMS 主動取 recipe<br />
                  RMS 取 golden<br />
                  <strong>RMS 自己比</strong>，回傳結果<br />
                  RMS 是比對的執行者
                </div>
              </div>
            </div>
            ...
            <P>上面虛線框是「算」— Spring Boot 裡的 Planner 根據系統類型和 request context，把所有決策打包成一個 <Code>ComparePlan</Code> 物件 return 出來，過程中完全不碰 DB、不碰 TCS、不碰機台。下面是「做」— C++ 裡的 Executor 拿到 Plan，照著欄位值去呼叫對應的原子操作，它不需要知道「為什麼要走 EDI」，只管 Plan 說什麼就做什麼。</P>

            <H3>三個角色的嚴格定義</H3>

            <DefCard
              title="Planner" label="算 · Spring Boot"
              desc={<>根據 toolId 和 request context，決定「接下來要怎麼做」。<br />不是固定查表 — V2 支持多種 compare mode，Planner 根據 context 決策。</>}
              tags={[
                { t: "純函數", v: "gray" }, { t: "可單測", v: "gray" }, { t: "根據 context 決策", v: "blue" },
                { t: "不碰 DB", v: "red" }, { t: "不碰網路", v: "red" }, { t: "不碰機台", v: "red" },
              ]}
              code={`// V2 — 根據 context 決策，不是固定值
plan = planner.plan("PROC-V2-01", { scope: PARTIAL, fields: ["temp", "pressure"] })
// → ComparePlan { mode: PARTIAL_CONTENT, fields: [...], execution: TCS_SIDE, ... }

// Scanner — 行為相對固定
plan = planner.plan("SCANNER-01", {})
// → ComparePlan { mode: FULL_CONTENT, execution: RMS_SIDE, fetch: VIA_EDI, ... }`}
            />
  ...
  compareExecution: TCS_SIDE,   // 誰負責比對
  fetchMethod: VIA_TCS,
  fieldsToCompare: ["temp", "pressure"] }`}
            ...
            <DefCard
              ...
              code={`recipe = fetcher.fetch(toolId, plan.fetchMethod)

if (plan.compareExecution == TCS_SIDE)
  return recipe                              // 只回傳，不比
else
  golden = goldenStore.get(recipeName)
  return comparator.run(golden, recipe, plan.compareMode)
...
// 分支看的是 Plan 欄位，不是 systemType`}
            ...
            <Table
              ...
              cellTag
              rows={[
                ["Process V2", { t: "多種（由 context 決定）", v: "red" }, { t: "TCS_SIDE", v: "amber" }, { t: "VIA_TCS", v: "blue" }],
                ["Process V1", { t: "KEY_ITEMS（固定）", v: "red" }, { t: "TCS_SIDE", v: "amber" }, { t: "VIA_TCS", v: "blue" }],
                ["Scanner", { t: "FULL_CONTENT（固定）", v: "red" }, { t: "RMS_SIDE", v: "green" }, { t: "VIA_EDI", v: "blue" }],
                ["Metrology", { t: "CHECKSUM（固定）", v: "red" }, { t: "RMS_SIDE", v: "green" }, { t: "VIA_TCS", v: "blue" }],
              ]}
            />
            ...
            <InfoCallout>
              <strong>Scanner 的未來：</strong>除了取 recipe 的方式（VIA_EDI）不同，Scanner 的比對邏輯應該完全被 V2 覆蓋。遷移時只需要把 Scanner Planner 的 return 值改成和 V2 一致（或直接共用 V2 Planner），Executor 不用動。
            </InfoCallout>
            ...
            <Table
              ...
              cellTag
              rows={[
                [{ t: "TCS_SIDE", v: "amber" }, "TCS 負責比，RMS 只提供 recipe", "fetch recipe → return（不呼叫 comparator）"],
                [{ t: "RMS_SIDE", v: "green" }, "RMS 負責比，取 recipe + golden + 比對", "fetch → get golden → compare → return result"],
              ]}
            />

            <InfoCallout>
              <strong>注意：</strong><Code>compareExecution</Code> 不一定只取決於系統類型。同一台 V2 機台，track-in 時可能是 TCS_SIDE（TCS 發起，RMS 回傳 recipe），但 Workflow 觸發的 compare 可能需要 RMS_SIDE（沒有 TCS track-in 發生）。Planner 需要根據觸發來源決定這個值。具體邏輯由實作時確認。
            </InfoCallout>
...
if (type == V1 || type == V2)
  return recipe           // TCS 端比
else if (type == METROLOGY)
  ok = hash(recipe) == hash(golden)
else
  ok = deepCompare(recipe, golden)`}
...
recipe = fetcher.fetch(plan.fetch)
if (plan.execution == TCS_SIDE)
  return recipe
golden = store.get(recipeName)
result = comparator.run(
           golden, recipe, plan.mode)`}
            ...
            <P>解決的問題：不同系統連接機台的方式不同（TCS vs EDI），但 Executor 不應該知道這些。</P>
...
Planner 不知道 TCS 的 API 長什麼樣。
Adapter 不知道現在是在處理哪套系統。`}</CodeBlock>

            <Callout>
              <strong>紅線：</strong>Adapter 內部允許 <Code>switch plan.tcsApiVersion</Code>（基於 Plan 欄位 dispatch）。<br />
              禁止 <Code>if systemType == V2</Code>（基於系統類型判斷）。一旦出現，代表有差異沒被 Plan 收斂。
            </Callout>
            ...
            <H3>可測試性 — 腦手分離的紅利</H3>
            <P>以前 4 套系統各自一個 compare-svc，要測比對邏輯就得把整條鏈路拉起來 — 連 TCS、連 DB、連機台。測試慢、環境難搭、壞了不知道是邏輯錯還是環境掛。</P>
            <P>算和做分離之後，加上 Spring Boot / C++ 的 process boundary，測試可以按層切開：</P>

            <H4>Planner — 純函數（Spring Boot，最好測）</H4>
            <CodeBlock>{`// V2 — 根據 context 產出不同 Plan
assert V2Planner.plan("PROC-V2-01", { scope: PARTIAL }) == {
  compareMode: PARTIAL_CONTENT,
  compareExecution: TCS_SIDE,
  fetchMethod: VIA_TCS, ...
}

// V2 — 不支持的 mode
assert V2Planner.plan("PROC-V2-01", { scope: UNKNOWN }) throws UnsupportedModeError

// Scanner — 固定行為
assert ScannerPlanner.plan("SCANNER-01", {}) == {
  compareMode: FULL_CONTENT,
  compareExecution: RMS_SIDE,
  fetchMethod: VIA_EDI, ...
}`}</CodeBlock>
            <P><strong>以前怎麼測？</strong> 沒辦法單獨測。決策散在 C++ 的各個 if-else 裡，要測「Scanner 走 EDI」就得真的連 EDI。現在只要看 Plan 的值。</P>

            <H4>Executor — mock 原子操作（C++）</H4>
            <CodeBlock>{`// TCS_SIDE → 只 fetch，不比
executor.execute(plan_tcs_side, mockOps)
assert mockFetcher.wasCalled == true
assert mockComparator.wasCalled == false  // 不比

// RMS_SIDE → fetch + compare
executor.execute(plan_rms_side, mockOps)
assert mockFetcher.wasCalled == true
assert mockComparator.wasCalled == true   // 比`}</CodeBlock>
            ...
            <MappingRow
              ...
              oldItems={["rms-v2/compare-svc", "rms-v1/compare-svc", "rms-scanner/compare-svc", "rms-metrology/compare-svc"]}
            ...
            <MappingRow
              title="機台通訊"
              oldTitle="現在（散落）"
              oldItems={["rms-v2/tcs-gateway", "rms-v1/tcs-client", "rms-scanner/edi-connector", "rms-metrology/tcs-client"]}
              oldNote="3 個 TCS client 各自實作"
              newTitle="新架構（C++ 共用 adapter）"
              newItems={["C++ adapters:", "├ TcsAdapter (×1)", "└ EdiAdapter (×1)"]}
              newNote="由 Plan.fetchMethod 決定走哪條。隨隔離艙各部署一份。"
            />
            <MappingRow
              title="API 層"
              oldTitle="現在（4 endpoints）"
              oldItems={["/api/v2/recipe/compare", "/api/v1/recipe/compare", "/api/scanner/recipe/compare", "/api/metrology/recipe/compare"]}
              oldNote="Client 要知道打哪個 endpoint"
              newTitle="新架構（1 endpoint）"
              newItems={["/api/recipe/compare?toolId=XXX"]}
              newNote="Client 只傳 toolId，路由在 Spring Boot 內部"
            />

            <Divider />
            <P style={{ color: T.textSec, fontSize: 14 }}>
              <strong>Part 2 預告：</strong>Track-in check flow 編排、Workflow template 與 node 設計、調機流程、Resolver 查表實作、C++ 介面規格、遷移 phase 細節。
            </P>
          </>
        ) : (
          // ═══════════════════════════
          ...
          <>
            ...
            <CodeBlock>{`// Scanner Planner — 加新欄位
{ fetchMethod: VIA_EDI, retryPolicy: EXPONENTIAL_BACKOFF, ... }

// Process V2 Planner — 回傳預設值
{ fetchMethod: VIA_TCS, retryPolicy: NO_RETRY, ... }
...
fetcher.fetch(toolId, plan.fetchMethod, plan.retryPolicy)`}</CodeBlock>
            ...
            <Table
              ...
              rows={[
                ...
                ["recipe 格式異常", "Executor → Fetcher", "C++", "回傳 INVALID_RECIPE_FORMAT"],
...
{ "error": "ADAPTER_UNAVAILABLE",
  "message": "Failed to fetch recipe from tool SCANNER-01",
  "retryable": true }

// Client 不會看到（C++ 內部錯誤）
// "EDI connection timeout at 10.2.3.4:8080"`}</CodeBlock>
            ...
            <SectionNum n={"D"} />
            <H2>附錄 D：遷移路徑</H2>
            <P>「逐漸往 V2 靠攏，改資料就好」— 只改 Spring Boot Planner 的 return 值。</P>

            <H3>範例：Scanner 收斂到 V2</H3>
            <CodeBlock>{`// Before — Scanner Planner (Spring Boot)
{ compareMode: FULL_CONTENT, fetchMethod: VIA_EDI,
  compareExecution: RMS_SIDE, ... }

// After — 改 Planner 的 return 值
{ compareMode: FULL_CONTENT, fetchMethod: VIA_TCS,
  compareExecution: TCS_SIDE, ... }

// C++ Executor 不用改。C++ Adapter 不用改。`}</CodeBlock>

            <Callout>
              <strong>注意：</strong>這個範例裡 compareExecution 從 RMS_SIDE 變成 TCS_SIDE，不只是改一個欄位 — 是「RMS 自己比」變成「TCS 比」的行為轉換。前提是 TCS 端能接受 Scanner 的 recipe 格式、TCS 比對邏輯能覆蓋 Scanner 的 case。Planner 的改動很小，但上線前要驗證 TCS 端的相容性。
            </Callout>
